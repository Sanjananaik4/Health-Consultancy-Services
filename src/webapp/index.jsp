...
<div class="card-group md-5">
  <div class="card custom-bg ml-5 mr-3 mb-5">
    <img class="card-img-top" src="resources/images/doctors.png" alt="Card image cap" style="width: 575px; height: 350px;">
    <div class="card-body">
  ...
  <div class="card custom-bg ml-3 mr-3 mb-5">
    <img class="card-img-top mt-4" src="resources/images/nurses.png" alt="Card image cap" style="width: 575px; height: 330px;">
    <div class="card-body">
  ...
  <div class="card custom-bg ml-3 mr-5 mb-5">
    <img class="card-img-top" src="resources/images/medicines.png" alt="Card image cap" style="width: 575px; height: 350px;">
    <div class="card-body">
